...
status,task,done_by,deadline,compleated_on,priority) values (0,dailyTask1,soundarya,
to_date('28-12-2019','dd-MM-yyyy'),to_date('27-12-2019','dd-MM-yyyy'),1
);

insert into daily_task (
status,task,done_by,deadline,compleated_on,priority) values (0,dailyTask2,nandhu,
